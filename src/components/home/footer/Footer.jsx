  ...
  return (
    <div className='footer'>
      ...
      <div className='thirddiv'>
        ...
        <div className='line'></div>
        <div className='bar'>
          <div className='bar1'><img className='barimg' src={email} alt=''></img><Link to="">testingself12@gmail.com</Link></div>
          <div className='bar1'><img className='barimg' src={phone} alt=''></img>6206******</div>
