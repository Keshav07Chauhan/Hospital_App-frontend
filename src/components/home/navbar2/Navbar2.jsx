  ...
  return (
    <div className='navbar2'>
      ...
      <div className='navbar22'>
        <div className='navbar221'><img className='navbar221img' src={email} alt=''></img>testingself12@gmail.com</div>
        <div className='navbar221'><img className='navbar222img' src={phone} alt=''></img>6206******</div>
