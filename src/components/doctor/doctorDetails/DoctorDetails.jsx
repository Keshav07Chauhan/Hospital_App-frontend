...
const DoctorDetails = () => {
    ...
    return (
        <div className='doctordetails'>
            <div className='doctorimage'><img className='doctorprofileimage' src={`https://hospital-app-backend-60sw.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
