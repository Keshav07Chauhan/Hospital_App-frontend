...
const EditDoctorDetails = () => {
    ...
    return (
        <div className='editdoctordetails'>
            <div className='editdoctorimage'><img className='editdoctorprofileimage' src={`https://hospital-app-backend-60sw.onrender.com/`+doctorDetails.profile_image} alt='doctor'></img></div>
