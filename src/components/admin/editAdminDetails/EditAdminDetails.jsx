...
const EditAdminDetails = () => {
    ...
    return (
        <div className='editadmindetails'>
            <div className='editadminimage'><img className='editadminprofileimage' src={`https://hospital-app-backend-60sw.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
