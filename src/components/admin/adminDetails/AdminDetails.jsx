...
const AdminDetails = () => {
    ...
    return (
        <div className='admindetails'>
            <div className='adminimage'><img className='adminprofileimage' src={`https://hospital-app-backend-60sw.onrender.com/` + adminDetails.profile_image} alt='admin'></img></div>
