...
const PatientDetails = () => {
    ...
    const getUserData = async (e) => {
        try {
            ...
            const details = await axios.get(`https://hospital-app-backend-60sw.onrender.com/getuserdetails`, { headers: { 'Authorization': `${token}` } });
    ...
    return (
        <div className='patientdetails'>
            <div className='patientimage'><img className='patientprofileimage' src={`https://hospital-app-backend-60sw.onrender.com/` + patientDetails.profile_image} alt='patient'></img></div>
