...
const PatientDashboard = () => {
  ...
  const getdoctors = async () => {
    try {
      const dataset = await axios.get("https://hospital-app-backend-60sw.onrender.com/getapproveddoctors");
        ...
        doctorDetails.map((item, index) => (
          <div key={index}>
            <div className='itemclass'>
              <img className='patientdashboardimage' src={`https://hospital-app-backend-60sw.onrender.com/` + item.profile_image} alt={item.name}></img>
